...
import footerLogo from "@/components/Shared/logo.png";
...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-white text-base-content flex justify-evenly  mx-auto">
      <div>
        <span className="footer-title mx-auto lg:text-2xl lg:mb-10">
          Welcome{" "}
        </span>
        <Image
          src={footerLogo}
          className="w-16 h-16 lg:w-20 lg:h-16 mx-auto"
        ></Image>
        <Link
          href="/"
          className="text-xl lg:text-2xl uppercase font-medium mx-auto"
        >
      ...
      <div>
        ...
        <Link
          href="/showcase"
          className="link link-hover mx-auto text-xl font-semibold"
        >
          Showcase
        </Link>
        <Link
      ...
      <div>
        ...
        <a className="link link-hover mx-auto text-xl font-semibold">
          Terms of use
        </a>
        <a className="link link-hover mx-auto text-xl font-semibold">
          Privacy policy
      ...
      <div>
        ...
        <div className="form-control w-80 ">
          <label className="label mx-auto">
            <span className="label-text lg:text-2xl font-semibold">
              Enter your Query
            </span>
          </label>
