...
import {
  ...
  primaryColor,
  success,
} from "../TypingTest/color/color";
import logo from "../../../public/Images/mg-typing-test-logo.png";

const TypingHead = ({ currentSpeed }) => {
  ...
  */
  ...
  return (
    <MainDiv>
      <Logo>
        <Image src={logo} alt="Let's test your bonding with keyboard" width="60" height="60" />
        <h1 data-text="Let's test your bonding with keyboard">Let's test your bonding with keyboard</h1>
      </Logo>
