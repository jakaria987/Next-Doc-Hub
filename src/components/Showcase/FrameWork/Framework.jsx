...
const Framework = () => {
    return (
        <div className='grid grid-cols-3 gap-5 items-center justify-center'>
            <div
                className="overflow-hidden  aspect-video bg-red-400 cursor-pointer rounded-sm relative group"
            >
                <div
      ...
      "
            ...
            <div
                className="overflow-hidden h-full w-[500px]  aspect-video bg-red-400 cursor-pointer rounded-md relative group row-span-3"
            >
                <div
                    className="rounded-md z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end"
                >
      ...
      "
            ...
            <div
                className="overflow-hidden  aspect-video  cursor-pointer rounded-md relative group"
            >
                <div
                    className="rounded-md z-50 opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out cursor-pointer absolute from-black/80 to-transparent bg-gradient-to-t inset-x-0 -bottom-2 pt-30 text-white flex items-end"
                >
